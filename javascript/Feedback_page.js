...
(function getInfomation() {
  ...
  sendBtn.onclick = () => {
    if (
      ...
      //information
      let option = document
        .querySelector(".form__selectContent span")
        .getAttribute("value");
      ...
      formDescription.textContent =
        "Your input is invaluable and will help us improve our services/products";
...
async function postData(data) {
  ...
  fetch(
    "https://docs.google.com/forms/d/e/1FAIpQLSeWhWVr-mxZsf_8mTGikCxElr2luo2bp3xUJ9TbEmf3MNtyfw/formResponse",
    {
      method: "POST",
      body: formData,
      mode: "no-cors",
